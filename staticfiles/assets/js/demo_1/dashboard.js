(function ($) {
  ...
  $(function () {
    ...
    if ($('#sales-statistics-overview').length) {
      ...
      var data_1_1 = [200, 75, 65, 130, 130, 145, 110, 145, 155, 149, 170];
      var data_1_2 = [200, 25, 20, 40, 70, 52, 49, 90, 70, 94, 110, 135];

      var data_2_1 = [200, 145, 155, 60, 75, 65, 130, 110, 145, 149, 170];
      var data_2_2 = [200, 70, 52, 90, 25, 20, 40, 70, 49, 94, 110, 135];

      var data_3_1 = [200, 75, 65, 130, 110, 145, 155, 60, 145, 149, 170];
      var data_3_2 = [200, 70, 52, 94, 110, 135, 90, 25, 20, 40, 70, 49];

      var data_4_1 = [200, 145, 65, 130, 75, 145, 149, 170, 110, 155, 60];
      var data_4_2 = [200, 70, 90, 25, 40, 20, 94, 110, 135, 70, 49, 52];
      var areaData = {

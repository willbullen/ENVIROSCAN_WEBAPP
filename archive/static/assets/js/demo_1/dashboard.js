...
(function ($) {
  ...
  $(function () {
    ...
    if ($('#total-revenue').length) {
      ...
      var data = {
        labels: ['2021-04-30T05:51:28.835Z', '2021-04-30T05:50:28.091Z', '2021-04-30T05:49:25.351Z', '2021-04-30T05:48:25.470Z', '2021-04-30T05:47:24.099Z', '2021-04-30T05:46:22.441Z', '2021-04-30T05:45:21.329Z', '2021-04-30T05:44:19.705Z', '2021-04-30T05:43:18.563Z', '2021-04-30T05:42:16.440Z', '2021-04-30T05:41:15.553Z'],
        datasets: [{
          label: 'Total Revenue',
          data: [423.0755, 423.7163, 423.5538, 422.7262, 423.2192, 424.2667, 424.4805, 424.6942, 423.5972, 424.9426, 425.4084],
          borderColor: '#9B86F1',
    ...
    if ($('#CO2_Chart_Old').length) {
      var CO2_Chart_OldCanvas = $("#CO2_Chart_Old").get(0).getContext("2d");
      var gradientStrokeFill_1 = CO2_Chart_OldCanvas.createLinearGradient(0, 0, 0, 450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      var gradientStrokeFill_2 = CO2_Chart_OldCanvas.createLinearGradient(0, 0, 0, 400);
      gradientStrokeFill_2.addColorStop(1, 'rgba(255, 255, 255, 0.01)');
      gradientStrokeFill_2.addColorStop(0, '#14c671');


      var data_1_1 = [423.0755, 423.7163, 423.5538, 422.7262, 423.2192, 424.2667, 424.4805, 424.6942, 423.5972, 424.9426, 425.4084];
      ...
      var labels = ['2021-04-30T05:51:28.835Z', '2021-04-30T05:50:28.091Z', '2021-04-30T05:49:25.351Z', '2021-04-30T05:48:25.470Z', '2021-04-30T05:47:24.099Z', '2021-04-30T05:46:22.441Z', '2021-04-30T05:45:21.329Z', '2021-04-30T05:44:19.705Z', '2021-04-30T05:43:18.563Z', '2021-04-30T05:42:16.440Z', '2021-04-30T05:41:15.553Z'];
      ...
      var CO2Chart = new Chart(CO2_Chart_OldCanvas, {
        type: 'line',
        data: areaData,
        options: areaOptions
      });
      document.getElementById('sales-statistics-legend').innerHTML = CO2Chart.generateLegend();

...
function setHistory(db_Data) {
    ...
    var maxMinAvg_Mini_2 = maxMinAvg(db_Data.Data.data, "Data_FlowC");
    ...
    var maxMinAvg_Mini_3 = maxMinAvg(db_Data.Data.data, "Instrument_Supply_Current");
    ...
    var maxMinAvg_Mini_4 = maxMinAvg(db_Data.Data.data, "Instrument_Temp");
...
function setCurrent(db_Data) {
    ...
    $("#Date").text(thisDate);
    // CORE DATA 1
    $("#Core_Heading_1").text('BLACK CARBON (ppm)');
    $("#Core_Value_1").text(db_Data.Data.Data_BC7.toFixed(1));
    $("#Core_Bar_1").attr('style', 'width: ' + getPercentage(db_Data.Data.Data_BC7, 420) + '%');
    // CORE DATA 2
    $("#Core_Heading_2").text('FLOW RATE (lpm)');
    $("#Core_Value_2").text(db_Data.Data.Data_FlowC.toFixed(1));
    $("#Core_Bar_2").attr('style', 'width: ' + getPercentage(db_Data.Data.Data_FlowC, 2) + '%');
    // CORE DATA 3
    $("#Core_Heading_3").text('PRESSURE (kPa)');
    $("#Core_Value_3").text(db_Data.Data.Instrument_Pressure.toFixed(1));
    $("#Core_Bar_3").attr('style', 'width: ' + getPercentage(db_Data.Data.Instrument_Pressure, 4) + '%');
    // CORE DATA 4
    $("#Core_Heading_4").text('TEMPERATURE (C)');
    $("#Core_Value_4").text(db_Data.Data.Instrument_Temp.toFixed(1));
    $("#Core_Bar_4").attr('style', 'width: ' + getPercentage(db_Data.Data.Instrument_Temp, 3) + '%');
    // MINI 1
    ...
    $("#Mini_Value_2").text(db_Data.Data.Data_FlowC.toFixed(1));
    $("#Mini_Bar_2").attr('style', 'width: ' + getPercentage(db_Data.Data.Data_FlowC, 45) + '%');
    // MINI 3
    $("#Mini_Heading_3").text('TEMPERATURE (C)');
    $("#Mini_Value_3").text(db_Data.Data.Instrument_Temp.toFixed(1));
    $("#Mini_Bar_3").attr('style', 'width: ' + getPercentage(db_Data.Data.Instrument_Temp, 1) + '%');
    // MINI 4
    $("#Mini_Heading_4").text('HUMIDITY (%)');
    $("#Mini_Value_4").text(db_Data.Data.Instrument_Humidity.toFixed(1));
    $("#Mini_Bar_4").attr('style', 'width: ' + getPercentage(db_Data.Data.Instrument_Humidity, 45) + '%');
    // MISC DATA
    $("#Misc_Heading_1").text('BLACK CARBON 1');
    $("#Misc_Value_1").text(db_Data.Data.Data_BC1.toFixed(1));
    $("#Misc_Heading_2").text('BLACK CARBON 2');
    $("#Misc_Value_2").text(db_Data.Data.Data_BC2.toFixed(1));
    $("#Misc_Heading_3").text('BLACK CARBON 3');
    $("#Misc_Value_3").text(db_Data.Data.Data_BC3.toFixed(1));
    $("#Misc_Heading_4").text('BLACK CARBON 4');
    $("#Misc_Value_4").text(db_Data.Data.Data_BC4.toFixed(1));
    $("#Misc_Heading_5").text('BLACK CARBON 5');
    $("#Misc_Value_5").text(db_Data.Data.Data_BC5.toFixed(1));
    $("#Misc_Heading_6").text('BLACK CARBON 6');
    $("#Misc_Value_6").text(db_Data.Data.Data_BC6.toFixed(1));
    $("#Misc_Heading_7").text('BLACK CARBON 7');
    $("#Misc_Value_7").text(db_Data.Data.Data_BC7.toFixed(1));
    $("#Misc_Heading_8").text('FLOW');
    $("#Misc_Value_8").text(db_Data.Data.Data_FlowC.toFixed(1));
    $("#Misc_Heading_9").text('PMT Signal 1');
    $("#Misc_Value_9").text(db_Data.Data.Data_BC1.toFixed(1));
    $("#Misc_Heading_10").text('PMT Signal 2');
    $("#Misc_Value_10").text(db_Data.Data.Data_BC1.toFixed(1));
    // MET DATA
...
var startWebSocket = function () {
    ...
    var ws_path = ws_scheme + '://' + window.location.host + '/aethalometer/';
...
var renderCharts = function () {
    ...
    var Quad_Chart_1 = $("#Quad_Chart_1").dxChart({
        ...
        series: [{
            ...
            pane: "Pane_2",
            type: "line",
            valueField: "Data_FlowC",
            name: "Pane 2",
            color: app.color.theme
        }, {
            pane: "Pane_3",
            type: "line",
            valueField: "Instrument_Pressure",
            name: "Pane 3",
            color: app.color.theme
        }, {
            pane: "Pane_4",
            type: "line",
            valueField: "Instrument_Temp",
            name: "Pane 4",
            color: app.color.theme
        }],
        valueAxis: [{
    ...
    var Mini_Chart_4 = $("#Mini_Chart_4").dxChart({
        ...
        series: [{
            pane: "Pane1",
            type: "line",
            valueField: "Instrument_Humidity",
            name: "PMT Signal",
            color: app.color.theme,
        }],
        valueAxis: [{

...
function setCurrent(db_Data) {
    ...
    // MISC DATA
    $("#Misc_Heading_1").text('PMT Signal');
    $("#Misc_Value_1").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_2").text('PMT Signal');
    $("#Misc_Value_2").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_3").text('PMT Signal');
    $("#Misc_Value_3").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_4").text('PMT Signal');
    $("#Misc_Value_4").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_5").text('PMT Signal');
    $("#Misc_Value_5").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_6").text('PMT Signal');
    $("#Misc_Value_6").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_7").text('PMT Signal');
    $("#Misc_Value_7").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_8").text('PMT Signal');
    $("#Misc_Value_8").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_9").text('PMT Signal');
    $("#Misc_Value_9").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    $("#Misc_Heading_10").text('PMT Signal');
    $("#Misc_Value_10").text(db_Data.Data.Data_PMT_Signal.toFixed(1));
    // MET DATA
...
var startWebSocket = function () {
    ...
    var ws_path = ws_scheme + '://' + window.location.host + ':8001/tucson/';

...
ALLOWED_HOSTS = ['20.229.97.149', 'localhost', 'enviroscan.azurewebsites.net', 'enviroscan.io', 'www.enviroscan.io', 'www.enviroscan-iot.com', '127.0.0.1']
...
MEDIA_ROOT = os.path.normpath(os.path.join(BASE_DIR, 'media')) # Directory where uploaded media is saved.
MEDIA_URL = '/media/' # Public URL at the browser

# Extra places for collectstatic to find static files.
STATICFILES_DIRS = (
    os.path.normpath(os.path.join(CORE_DIR, 'core/static')),
